...
![Obrázek Pyramida všeho důležitého v EG](https://egovedu.tinydot.com/media/pyramida-eg-vseho.png)
...
Pyramidu můžeme číst dvěma způsoby. Zdola, pokud chceme myslet jako realizátor konkrétní oblasti či služby a shora, pokud jsme manažeři a potřebujeme, aby nám vše klaplo dohromady. Pokud na jakékoliv z těchto pater zapomeneme, máme problém.
...
- [eSbírka](https://zakony.gov.cz) je oficiálním autoritativním zdrojem znění právních předpisů v .
- Existuje i uživatelsky lepší řešení s nejvíce funkcemi jeví [nástroj Zákony pro lidi](https://www.zakonyprolidi.cz)
...
- [stránka Agendový model veřejné správy z NAP](https://archi.gov.cz/nap:agendovy_model_verejne_spravy) srozumitelně popisuje celý koncept agend a obsah jejich ohlašování a související povinnosti.
- Jednotlivé agendy a údaje o nich jsou veřejně přístupné z Registru práv a povinností, [nástroj Seznam a podrobnosti agend ohlášených v Registru práv a povinností](https://rpp-ais.egon.gov.cz/gen/agendy-detail/) je rozcestníkem s odkazy na podrobnosti ke každé agendě.
- [stránka Registr práv a povinností z NAP](https://archi.gov.cz/nap:rpp) popisuje obsah RPP včetně obsahu agend
...
Služby veřejné správy jsou formálně pojmenovány a jsou poskytovány na základě právních předpisů. Existuje Katalog služeb, v němž si kdokoliv může zjistit, jaké služby jsou kde poskytovány. Z tohoto Katalogu služeb vycházíme i při digitalizaci služeb.
...
- Existují tři hlavní druhy procesů v úřadu, každý má svá specifika.
...
{{page>egdilna:druhy-procesu-v-uradu&noheader}}
...
- [stránka Sdílení údajů veřejné správy z NAP](https://archi.gov.cz/nap:sdileni_udaju) popisuje výměnu v rámci PPDF
