Od 1. dubna 2026 a pak v aktualizaci od 20. července 2026 vydalo OHA závazný architektonický rámec pro generický AIS. Z něj jsou derivovány následující konkrétní požadavky, jak má AIS fungovat a co má jeho správce dělat a zajistit:
...
> AIS je připojen na referenční rozhraní veřejné správy pro účely vazeb na AIS jiného orgánu veřejné správy.

Požadavek 1.2 Čerpání údajů v rozsahu oprávnění [ZoZR, ZoISVS]

> Čerpá potřebné údaje v rozsahu oprávnění a potřebném pro vyřízení služeb poskytovaných AIS.

Požadavek 1.3 Poskytování vlastních údajů jiným AIS [ZoZR, ZoISVS]

> Poskytuje vlastní údaje, které mají být podle právních předpisů nebo oprávněného požadavku zpřístupňovány jiným AIS.

Požadavek 1.4 Vyrozumění o změně údajů prostřednictvím AIS-V [ZoZR, ZoISVS]

> U publikovaných údajů, u nichž je to relevantní, zajišťuje vyrozumění o změně údajů prostřednictvím AIS-V.

Požadavek 2.1 Identifikace a autentizace kvalifikovaným systémem [zákon č. 250/2017 Sb., o elektronické identifikaci]

> AIS má zajištěnou identifikaci a autentizaci fyzických osob, u kterých se vyžaduje prokázání totožnosti pomocí kvalifikovaného systému.

Požadavek 2.2 Vyloučení proprietární identifikace a autentizace [zákon č. 250/2017 Sb., o elektronické identifikaci]

> AIS nevyužívá jiné proprietární způsoby identifikace a autentizace, pokud není použití jiného způsobu odůvodněno specifickou situací nebo právním rámcem.

Požadavek 3 Využívání Centrálního místa služeb [ZoISVS]

> Vazby AIS na AIS jiného orgánu veřejné správy jsou zajištěny prostřednictvím CMS/KIVS, pokud se na danou vazbu tento režim vztahuje.

Požadavek 4.1 Vedení AIS v rejstříku ISVS [ZoZR]

> AIS je veden v rejstříku ISVS v příslušném rozsahu.

Požadavek 4.2 Ohlášení agendy vykonávané prostřednictvím AIS [ZoZR]

> Současně je ohlášena agenda, kterou AIS podporuje, včetně údajů potřebných k řádnému výkonu činností v agendě.

Požadavek 5.1 Ohlášení služeb v katalogu služeb [ZoPDS]

> Služby veřejné správy podporované AIS jsou ohlášeny v katalogu služeb v rozsahu, v jakém se na ně tato povinnost vztahuje.

Požadavek 5.2 Vazba služeb na životní události [ZoPDS]

> U služeb je současně uvedena vazba na životní události, pokud je pro danou službu relevantní.

Požadavek 6 Využívání Registru zastupování [ZoPDS]

> U digitálních služeb je posouzeno, zda má být umožněno elektronické zastupování prostřednictvím Registru zastupování.

Požadavek 7 Využívání CAAIS [ZoZR]
...
> Porovná záměr se stávajícím stavem architektury orgánu veřejné správy a prostřednictvím aktualizace informační koncepce provede strategické naplánování vytvoření nebo rozvoje AIS.

Požadavek 9 AIS navrhován jako součást VS a PPDF [tento pokyn a NAP]

> AIS musí být chápán jako součást propojeného prostředí veřejné správy, nikoli jako izolované řešení jednoho úřadu nebo jedné agendy.

Požadavek 10 AIS je navrhován s ohledem na optimální využití aplikačního portfolia úřadu [tento pokyn a NAP]

> Musí být zřejmé, zda jde o samostatný agendový systém, součást širšího řešení, navazující systém nebo systém využívající společné služby úřadu, resortu nebo státu.

Požadavek 11 Pro AIS jsou jmenovitě stanoveny klíčové role [vyhláška o dlouhodobém řízení ISVS]

> AIS (budoucí AIS) má aktem řízení přiděleného věcného správce, technického správce a provozovatele, případně aplikačního datového a infrastrukturního a bezpečnostního architekta.

Požadavek 12.1 Odpovědnost OVS za zadání, rozhodnutí a akceptaci [soubor řady předpisů]

> Odpovědnost za zadání, rozhodnutí, akceptaci a dlouhodobé řízení AIS zůstává na orgánu veřejné správy.

Požadavek 12.2 Nezastupitelnost odpovědnosti dodavatelem, včetně cloudu [soubor řady předpisů]
...
> AIS je zařazen v informační koncepci orgánu veřejné správy a je v souladu s Informační koncepci ČR a navazujícími dokumenty.

Požadavek 14 Naplnění IK ČR [ZoISVS]
...
> AIS je vždy navrhován tak, aby podpořil (byznys) cíle úřadu při výkonu agendových služeb veřejné správy a při efektivním využití ICT infrastruktury úřadu.

Požadavek 16 Podpora digitální transformace úřadu [tento pokyn a NAP]
...
> Jakou agendu nebo agendy AIS podporuje.

Požadavek 18 Působnost

> Který OVM agendu vykonává a v jakém rozsahu vykonává působnost.

Požadavek 19 Služby veřejné správy

> Jaké služby AIS podporuje, poskytuje nebo mění.

Požadavek 20 Úkony

> Jaké úkony tvoří jednotlivé služby a kdo je vykonává.

Požadavek 21 RPP a katalog služeb

> Zda jsou agenda, působnost, služby, úkony, údaje a vazba AIS evidovány v příslušných evidencích.

Požadavek 22 Role

> Kdo je klient služby, poskytovatel služby, interní uživatel a případně další účastník.

Požadavek 23 Obslužné kanály

> Jakými kanály je služba dostupná a zda je jasné, že kanál není služba.

Požadavek 24 Pravidla služby

> Jaká jsou pravidla dodávky business služby a co to znamená pro její podporu v AIS, zejména dostupnost, přístupy a oprávnění, práce s údaji, ochrana údajů, auditovatelnost a návaznosti na další procesy.

Požadavek 25 Věcné zadání
...
> Nikdy nenavrhujte podobu agendy, služby nebo úkonu samostatně, izolovaně. Vždy ji navrhujte v kontextu ostatních agend a služeb. Jenom tak můžete přijít na to, co mohou mít vaše agendy a služby společné.

Požadavek 27 Zajištění jednotnosti služeb [tento pokyn a NAP]

> „Venku“ stojí jeden klient pro většinu vašich služeb, on si přeje, aby se Vaše služby různých agend chovaly konzistentně, nejlépe stejně. Tak je začněte sjednocovat.

Požadavek 28 Sjednocení interních funkcí a procesů [tento pokyn a NAP]

> Ani interně si nepřejete, aby si každá agenda zaváděla kompletně nové procesy, znovu a znovu -> například správu kmenových dat, obsluhu klientů, sdílení agendových údajů ven a dovnitř úřadu, správu vybraných poplatků nebo nevybraných pohledávek za poplatky, apod.. Sjednocené business procesy a funkce vám následně umožní zjednodušit a zlevnit jejich IT podporu aplikačními řešeními. (100 levných aplikací, každá pro jednu agendu, je nakonec mnohem dražších než zpočátku draze vypadající řešení pro společné funkce všech 100 agend).

Požadavek 29 Zaměření na sdílené procesy a funkce [tento pokyn a NAP]

> Při analýze a návrhu agend, služeb a úkonů se proto primárně zaměřte na to, co má vaše agend s ostatními společné. Teprve potom popište, čím se individuálně liší. Kdybyste od počátku mylně považovali vaši agendu za cela unikátní, nikdy byste neviděli potenciál jednotných procesů.

Požadavek 30 Zahájení procesu sjednocení a sdílení procesů a funkcí [tento pokyn a NAP]
...
> Jaké věcné oblasti dat a hlavní údaje AIS zpracovává.

Požadavek 32 Zdroj údajů

> Zda údaj pochází ze základního registru, jiného ISVS, vlastního agendového zpracování, dokumentu nebo provozu systému.

Požadavek 33 Účel použití

> Pro jakou agendu, službu, úkon nebo rozhodovací proces je údaj potřebný.

Požadavek 34 Sdílení údajů

> Zda a jak jsou údaje poskytovány jiným agendám, systémům nebo subjektům.

Požadavek 35 Datová rozhraní

> Jakými rozhraními AIS údaje čerpá nebo poskytuje.

Požadavek 36 Klasifikace dat

> Jak jsou data v AIS klasifikována podle citlivosti, kritičnosti a právní ochrany a jaké požadavky z toho vyplývají pro jejich ochranu, zálohování, obnovu a přístupová oprávnění.

Požadavek 37 Vazba na RPP

> Zda jsou údaje a oprávnění k přístupu k údajům evidovány v RPP v příslušném rozsahu.

Požadavek 38 Uchovávání údajů

> Jaké údaje musí být uchovávány, v jaké podobě a s jakou vazbou na archivaci nebo spisovou službu.

Požadavek 39 Identifikátory
